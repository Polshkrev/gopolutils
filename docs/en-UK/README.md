...
3. [Diagrams](/docs/en-UK/diagrams.md)
4. [Events](/docs/en-UK/events.md)
5. Globals
    1. [Logger](/docs/en-UK/logger.md)
    2. [Version](/docs/en-UK/version.md)
    3. [Exception](/docs/en-UK/exception.md)
6. [Collections](/docs/en-UK/collections/collections.md)
    1. Interfaces
    ...
    3. Structures
        ...
        7. Safe
            1. [Array](/docs/en-UK/collections/safe/array.md)
            2. [Map](/docs/en-UK/collections/safe/map.md)
            3. [Queue](/docs/en-UK/collections/safe/queue.md)
            4. [Stack](/docs/en-UK/collections/safe/stack.md)
7. Fayl
