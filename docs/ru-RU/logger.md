...
Чтобы записить отформатированного сообщения в лог необходимо вызвать метод `Logf`. Этот метод принимает уровень, сообщение и различное количество аргументов для форматирования сообщения.
### Деструкция
